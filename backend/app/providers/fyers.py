...
class FyersMarketDataProvider:
    ...
    def symbol_info(symbol: str) -> SymbolInfo:
        ...
        aliases = {
            ...
            "NIFTY_CAPITAL_MKT": "NSE:NIFTYCAPITALMARKETS-INDEX",
